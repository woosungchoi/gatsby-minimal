...
Y 엔터를 누르면 자동으로 설정해줍니다. 다만 Nginx 설정을 원하는대로 바꾸려면 조금은 번거롭습니다.
...
밑에 `5-1. SSL 설정하기(무료 도메인 전용)`을 참고하세요!
...
위 명령어로 Nginx 설정을 할 것입니다. aced.ga는 자신의 환경에 맞게 수정해주세요.
