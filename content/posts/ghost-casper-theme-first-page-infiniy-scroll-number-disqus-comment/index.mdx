...
tags: 
  - Ghost
banner: ./front-page.png
slug: "/ghost-casper-theme-first-page-infiniy-scroll-number-disqus-comment"
date: '2020-06-03T14:49:51.000Z'
description: ghost 플랫폼의 기본테마인 casper는 첫화면에 기본적으로 인피니티 스크롤을 적용하고 있습니다. 페이지 기능이 없이 그냥 스크롤만 하면 새로운 글이 로딩이 되는데, 그 숫자를 줄이고, 댓글 플러그인을 활성화하는 방법에 대해 알려드립니다.
---
![](./front-page.png)
