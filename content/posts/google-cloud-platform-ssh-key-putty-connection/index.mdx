...
tags: 
  ...
  - Putty
  - SFTP
banner: ./ssh-connection-cover-resized-tiny.jpg
slug: "/google-cloud-platform-ssh-key-putty-connection"
date: '2020-06-02T05:32:00.000Z'
description: 구글 클라우드 플랫폼에 SSH키를 입력하고 PuTTY 접속하는 방법에 대하여 시작부터 끝까지 자세하게 설명해드립니다.
---
![](./ssh-connection-cover-resized-tiny.jpg)
...
![](./06-go-to-metadata.png)

위와 같이 Compute Engine -> 메타데이터를 클릭합니다.

![](./07-go-ssh-modify.png)
