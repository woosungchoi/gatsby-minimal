...
tags: 
  ...
  - Cloudflare
  - Nameserver
slug: "/cloudflare-sign-in-and-change-nameserver"
banner: ./cloudflare-logo_o.png
date: '2020-05-27T19:02:00.000Z'
description: 지난 번에 freenom에서 무료 도메인 주소를 얻었습니다. 그런데 freenom은 기능이 별로 없기 때문에 다양한 기능을 무료로 제공해주는 Cloudflare에 가입하는 것이 좋습니다.
---
![](./cloudflare-logo_o.png)

지난 번에 freenom에서 무료 도메인 주소를 얻었습니다. 그런데 freenom은 기능이 별로 없기 때문에 다양한 기능을 무료로 제공해주는 Cloudflare에 가입하는 것이 좋습니다.

---

무료도메인(ga,tk,ml,cf,gq)의 경우 클라우드플레어에서 API 인증을 막았습니다.

무료도메인의 와일드카드 SSL 인증서나 DDNS 기능을 원하시면 LuaDNS도 좋은 선택입니다.
