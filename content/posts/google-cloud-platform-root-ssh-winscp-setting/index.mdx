...
tags: 
  - Google Cloud
banner: ./sftp-cover.jpg
slug: "/google-cloud-platform-root-ssh-winscp-setting"
date: '2020-06-02T07:11:35.000Z'
description: SFTP를 사용하여 탐색기처럼 폴더를 이동하고, 파일을 즉각적으로 수정하는 방법에 대한 글입니다. root 권한으로 보안에 취약하지만 쉽게 사용할 수 있는 장점이 있습니다.
---
![](./sftp-cover.jpg)
...
![](./02-go-to-metadata.png)

위와 같이 Compute Engine -> 메타데이터를 클릭한 뒤 

![](./03-go-ssh-modify.png)
