...
tags: 
  - Google Cloud
banner: ./vsftpd-cover.jpg
slug: "/google-cloud-platform-ubuntu-20-04-vsftpd-ftp-setting"
date: '2020-06-02T17:53:31.000Z'
description: 우분투 20.04에서 vsftpd 패키지를 설치하고 기본 셋팅을 합니다. 그 후 서버와 구글 클라우드 방화벽 셋팅을 하고, 파일질라에 접속하여 파일을 전송합니다.
---
![](./vsftpd-cover.jpg)
...
![](./01-open-google-cloud.png)

구글 클라우드 플랫폼에 접속 -> VPC 네트워크 -> 방화벽을 클릭합니다.

![](./02-make-firewall.png)
