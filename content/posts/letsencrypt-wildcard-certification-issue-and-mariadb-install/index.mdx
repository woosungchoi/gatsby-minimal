...
2. `Cloudflare`가 아닌 다른 DNS 서비스를 이용한다. (<a href="https://asia.cloudns.net/" target="_blank" rel="noopener noreferrer">ClouDNS</a> 등)
...
위 링크를 그대로 따라하시면 매우 편하게 와일드카드 인증서 발급 및 자동갱신을 적용할 수 있습니다.
