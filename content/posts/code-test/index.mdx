...
Nginx코드는 아직 인식하지 못하네요.

<a href="https://github.com/FormidableLabs/prism-react-renderer" target="_blank" rel="noopener noreferrer">prism-react-renderer 깃허브 페이지</a>

위 깃허브 링크를 보니 nginx는 없네요 ㅠㅠ 어쩔 수 없다고 생각합니다. 그냥 title만 붙이는걸로 해야될 것 같습니다.
