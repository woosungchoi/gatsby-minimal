...
tags: 
  - Ghost
banner: ./time-cover.jpg
slug: "/ghost-blog-casper-theme-change-date-format"
date: '2020-05-30T13:20:10.000Z'
description: ghost 블로그의 casper테마의 시간표시형식을 한국식으로 바꾸는 방법입니다. hbs를 수정하고 ghost를 재실행하면 변경이 가능합니다.
---
![](./time-cover.jpg)
